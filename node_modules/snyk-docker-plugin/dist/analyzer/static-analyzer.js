...
async function analyze(targetImage, dockerfileAnalysis, options) {
    ...
    const { imageId, manifestLayers, extractedLayers, rootFsLayers, } = await archiveExtractor.getArchiveLayersAndManifest(options.imageType, options.imagePath, staticAnalysisActions);
